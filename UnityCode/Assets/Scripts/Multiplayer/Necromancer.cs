...
public class Necromancer : NetworkBehaviour {
    ...
    void Update ()
    {
        ...
        if (GameObject.Find("MainCamera").GetComponent<CameraController>().DisablePlayerMovement == false)
        {
...
// Player is moving.
                    ...
                    {
                        GameObject ninjastar = (GameObject)Instantiate(NinjaStar, ObjectSpawnTransform);
                        if (m_facingDirection == 1)
                        {
                        ...
                        ninjastar.transform.parent = null;
                        ninjastar.transform.localScale = new Vector3(2, 2, 2);
                    }
